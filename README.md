...
- 'scale data.xlsx' : The dataset contains subjective workload assessments from 30 participants, including responses to the NASA Task Load Index (NASA-TLX) and the Subjective Workload Assessment Technique (SWAT) scales.
- 'preprocessing and feature extraction.py' : Performs EEG preprocessing (e.g., filtering, normalization) and feature extraction (e.g., time/frequency domain features) from raw EDF data.
